...
//Extraer si un proyecto está activo
  ...
  //Función que se ejecuta cuando el usurio presiona el botón de ELIMINAR TAREA
  const tareaEliminar = id => {
    eliminarTarea(id);
    obtenerTareas(proyectoActual.id);
  }

  //Funcion que modidica el estado de las tareas
  ...
  //Agregar una tarea actual acuado el usuario desea editarla
